...
namespace CodeLibrary24.FlyCam
{
    public class FlyCam : MonoBehaviour
    {
        ...
        private void LookAround()
        {
            ...
            currentMouseDelta = Vector2.SmoothDamp(currentMouseDelta, targetMouseDelta, ref mouseSmoothVelocity, rotationSmoothTime);
        ...
        private void Move()
        {
            ...
            float verticalMoveInput = (Keyboard.current.eKey.isPressed ? 1 : 0) - (Keyboard.current.qKey.isPressed ? 1 : 0);
            ...
            Vector3 direction = (transform.forward * moveInput.y + transform.right * moveInput.x + transform.up * verticalMoveInput);
